...
def get_namedentities(text):
    ...
    """
    st = StanfordNERTagger('utils/english.conll.4class.caseless.distsim.crf.ser.gz',
                           'utils/stanford-ner.jar', encoding='utf-8')
...
def extract_features(text, candidate_keywords, corpus_entry, dictionary):
    ...
    feature_names = ['Named Entity', 'Noun Phrase', 'N-gram', 'Term Freq', 'TF-IDF', 'Term Length',
